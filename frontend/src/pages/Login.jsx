    ...
    <div className="min-h-screen bg-[#0B1220] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="font-display text-3xl font-medium text-white">Welcome back</h1>
          <p className="text-slate-400 mt-1.5">Sign in to continue to JobConnect</p>
        </div>
        ...
        <div className="bg-[#111A2E] rounded-2xl shadow-2xl shadow-black/30 border border-white/10 p-8">
          ...
          <p className="text-center text-slate-400 text-sm mt-6">
            ...
            <Link to="/register" className="text-[#D4B678] font-semibold hover:underline">
              Sign up
            </Link>
          </p>
        </div>
